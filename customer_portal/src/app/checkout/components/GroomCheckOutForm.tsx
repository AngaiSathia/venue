...
interface GroomCheckOutFormProps {
...
const GroomCheckOutForm: FC<GroomCheckOutFormProps> = ({
  setActiveStep,
  activeStep,
}) => {
  const renderGroomCheckOutForm = () => {
  ...
  return renderGroomCheckOutForm();
};

export default GroomCheckOutForm;
